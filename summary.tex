...
The third contribution is an improved algorithm for solving these POMDPs online.
...
\Cref{chap:uav,chap:multilane} evaluate their findings based on simplistic models of other vehicles.
