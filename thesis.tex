...
However, obtaining the exact solution to a general POMDP is an intractable problem. % TODO Why
...
Previous solvers exhibit suboptimal behavior, a failure that is due to two problems.
